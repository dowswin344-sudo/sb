...
=======================================================================
FICHIER : cgu.php
PAGE    : Conditions Générales d'Utilisation de SBEE+
...
<head>
    ...
    <meta name="description" content="Conditions Générales d'Utilisation de SBEE+, la plateforme officielle de la SBEE Bénin.">
    <title>Conditions Générales d'Utilisation — SBEE+</title>
    ...
    <style>
/* ============================================================
   CHARTE SBEE+ – IDENTIQUE À MENTIONS.PHP / CONFIDENTIALITE.PHP
   ============================================================ */
:root {
    --primary: #A83236;
    --primary-dark: #7E2428;
...
.cgu-text { padding: 0 22px 22px; color: var(--text-soft); font-size: 13px; line-height: 1.7; }
.cgu-text p { margin: 1.2em 0; }
.cgu-text ul { margin: 0.8em 0; padding-left: 1.5em; }
.cgu-text li { margin: 0.5em 0; }
.cgu-text a { color: var(--primary-dark); text-decoration: underline; }
.cgu-text a:hover { color: var(--primary); }
.legal-subtitle {
...
@media (max-width: 520px) {
    ...
    .section-head, .cgu-text { padding-left: 16px; padding-right: 16px; }
    ...
    <div class="page-header">
        <div class="header-wrap">
            <div>
                ...
                <h1 class="header-title">Conditions Générales d'Utilisation</h1>
                <p class="header-sub">Cadre d'utilisation de la plateforme SBEE+ : accès au service, responsabilités, signalements, données personnelles et règles applicables.</p>
            </div>
            <div><span class="role-badge"><i class="bi bi-file-text-fill"></i> CGU</span></div>
        </div>
    </div>

    <div class="main-content">
        <!-- SOMMAIRE EN COLONNES (3 colonnes) -->
        <div class="toc-card">
            <div class="toc-head">
            ...
            <div class="toc-list">
                <a href="#objet"><i class="bi bi-dot"></i> 1. Objet</a>
                <a href="#acces"><i class="bi bi-dot"></i> 2. Accès</a>
                <a href="#compte"><i class="bi bi-dot"></i> 3. Compte</a>
                <a href="#utilisation"><i class="bi bi-dot"></i> 4. Utilisation</a>
                <a href="#signalement"><i class="bi bi-dot"></i> 5. Signalements</a>
                <a href="#coupures"><i class="bi bi-dot"></i> 6. Coupures</a>
                <a href="#responsabilite"><i class="bi bi-dot"></i> 7. Responsabilité</a>
                <a href="#propriete"><i class="bi bi-dot"></i> 8. Propriété</a>
                <a href="#donnees"><i class="bi bi-dot"></i> 9. Données</a>
                <a href="#modification"><i class="bi bi-dot"></i> 10. Modification</a>
                <a href="#droit"><i class="bi bi-dot"></i> 11. Droit applicable</a>
                <a href="#contact"><i class="bi bi-dot"></i> 12. Contact</a>
            </div>
        </div>

        <div class="section-card">
            <div class="section-head">
                <div class="section-label"><i class="bi bi-file-text-fill"></i> Conditions Générales d'Utilisation</div>
                <div class="section-sub">Dernière mise à jour : <?= date('d/m/Y') ?></div>
            </div>
            <div class="cgu-text">
                <p>Les présentes conditions générales d'utilisation, ci-après les <strong>CGU</strong>, régissent l'accès et l'utilisation de la plateforme <strong>SBEE+</strong>, ci-après la <strong>Plateforme</strong>, éditée par la <strong>Société Béninoise d'Énergie Électrique (SBEE)</strong>. En vous inscrivant ou en utilisant la Plateforme, vous acceptez sans réserve les présentes CGU.</p>

                <div class="legal-subtitle" id="objet">1. Objet</div>
                <p>SBEE+ est une plateforme en ligne permettant aux abonnés et au grand public de signaler des pannes électriques, de suivre l'évolution de leurs signalements, de consulter les coupures programmées et d'échanger avec les services de la SBEE.</p>

                <div class="legal-subtitle" id="acces">2. Accès à la plateforme</div>
                <p>L'accès à la Plateforme est gratuit pour tous les utilisateurs. Certaines fonctionnalités, notamment la création de compte, le suivi personnalisé et l'historique des demandes, nécessitent une inscription préalable. L'utilisateur s'engage à fournir des informations exactes, complètes et à jour.</p>
                <p>La SBEE se réserve le droit de suspendre ou de supprimer tout compte ne respectant pas ces obligations ou utilisé de manière abusive.</p>

                <div class="legal-subtitle" id="compte">3. Création et gestion du compte</div>
                <ul>
                    <li>L'inscription est ouverte aux personnes utilisant les services de la SBEE ou souhaitant signaler un incident électrique.</li>
                    <li>Chaque utilisateur est responsable de l'exactitude des informations fournies lors de l'inscription.</li>
                    <li>Les identifiants de connexion, notamment téléphone, email et mot de passe, sont personnels et confidentiels.</li>
                    <li>L'utilisateur est responsable des actions réalisées depuis son compte.</li>
                    <li>En cas de perte, de vol ou de divulgation des identifiants, l'utilisateur doit contacter rapidement le support SBEE.</li>
                </ul>

                <div class="legal-subtitle" id="utilisation">4. Utilisation de la plateforme</div>
                <p>L'utilisateur s'engage à utiliser la Plateforme conformément à sa destination et aux lois en vigueur. Il est notamment interdit de :</p>
                <ul>
                    <li>Publier des contenus illicites, injurieux, diffamatoires ou portant atteinte aux droits des tiers.</li>
                    <li>Effectuer des signalements abusifs, frauduleux ou volontairement inexacts.</li>
                    <li>Tenter de contourner les mesures de sécurité ou d'accéder à des données non autorisées.</li>
                    <li>Utiliser des robots, scripts ou moyens automatisés sans autorisation.</li>
                    <li>Usurper l'identité d'un autre utilisateur ou d'un représentant de la SBEE.</li>
                </ul>
                <p>Tout comportement contraire aux présentes CGU peut entraîner la limitation, la suspension ou la fermeture du compte, sans préjudice d'éventuelles poursuites.</p>

                <div class="legal-subtitle" id="signalement">5. Signalement des pannes</div>
                <p>Le signalement d'une panne doit être effectué de bonne foi. L'utilisateur doit décrire précisément la nature du problème, l'adresse, la zone concernée et les éventuelles urgences.</p>
                <p>La SBEE traite les signalements selon leur priorité, leur criticité et les moyens techniques disponibles. Un numéro de référence peut être généré afin de permettre le suivi du dossier.</p>
                <p>La SBEE s'engage à mettre en œuvre les moyens raisonnables pour assurer le traitement des signalements dans les meilleurs délais, sans garantir un délai fixe dans tous les cas.</p>

                <div class="legal-subtitle" id="coupures">6. Coupures programmées</div>
                <p>Les informations relatives aux coupures programmées sont fournies à titre indicatif. La SBEE s'efforce de les actualiser régulièrement, mais les horaires, zones et durées peuvent être modifiés en raison de contraintes techniques, climatiques ou opérationnelles.</p>
                <p>La SBEE ne saurait être tenue responsable des préjudices directs ou indirects liés à une coupure annoncée, reportée, prolongée ou non annoncée lorsque les circonstances l'exigent.</p>

                <div class="legal-subtitle" id="responsabilite">7. Responsabilité</div>
                <p>La SBEE met en œuvre les moyens raisonnables pour assurer la continuité, la sécurité et la disponibilité de la Plateforme. Toutefois, elle ne peut garantir une absence totale d'interruptions, d'erreurs, de pertes de données ou d'attaques informatiques.</p>
                <p>L'utilisateur accepte que la Plateforme soit utilisée en l'état. La SBEE ne pourra être tenue responsable des dommages indirects, notamment pertes de données, manque à gagner ou atteinte à l'image, résultant de l'utilisation ou de l'impossibilité d'utiliser la Plateforme, sauf faute lourde ou violation délibérée.</p>
                <p>Les liens hypertextes vers des sites tiers sont fournis pour information et n'engagent pas la responsabilité de la SBEE.</p>

                <div class="legal-subtitle" id="propriete">8. Propriété intellectuelle</div>
                <p>L'ensemble des contenus présents sur la Plateforme, notamment textes, logos, graphismes, icônes, images, vidéos, bases de données et éléments de code, est protégé par les règles relatives à la propriété intellectuelle.</p>
                <p>Toute reproduction, représentation, adaptation ou exploitation partielle ou totale, par quelque procédé que ce soit, est interdite sans autorisation écrite préalable de la SBEE ou des titulaires de droits concernés.</p>
                <p>Les marques SBEE, SBEE+ et leurs logos sont des signes distinctifs appartenant à leurs titulaires respectifs.</p>

                <div class="legal-subtitle" id="donnees">9. Protection des données personnelles</div>
                <p>Les données personnelles collectées sont traitées conformément à la <a href="confidentialite.php">Politique de confidentialité</a> de la Plateforme. Elles sont utilisées pour la gestion des comptes, le suivi des signalements, les notifications, la sécurité et l'amélioration du service.</p>
                <p>L'utilisateur peut exercer ses droits d'accès, de rectification, d'effacement et d'opposition en contactant le support ou le délégué compétent à l'adresse <a href="mailto:dpo@sbee.bj">dpo@sbee.bj</a>.</p>

                <div class="legal-subtitle" id="modification">10. Modification des CGU</div>
                <p>La SBEE se réserve le droit de modifier les présentes CGU à tout moment. Les modifications entrent en vigueur dès leur publication sur la Plateforme.</p>
                <p>L'utilisateur est invité à consulter régulièrement cette page. La poursuite de l'utilisation de la Plateforme après modification vaut acceptation des nouvelles conditions.</p>

                <div class="legal-subtitle" id="droit">11. Droit applicable et juridiction</div>
                <p>Les présentes CGU sont régies par le droit béninois. Tout litige relatif à leur interprétation ou à leur exécution relève des juridictions compétentes du Bénin.</p>

                <div class="legal-subtitle" id="contact">12. Contact</div>
                <p>Pour toute question relative aux présentes CGU ou à l'utilisation de la Plateforme, vous pouvez contacter la SBEE :</p>
                <ul>
                    <li>Par email : <a href="mailto:contact@sbee.bj">contact@sbee.bj</a></li>
                    <li>Pour les urgences électriques : <a href="tel:19">19</a></li>
                    <li>Depuis la page d'accueil : <a href="index.php#contact">formulaire de contact</a></li>
                </ul>
        ...
        <div class="page-actions">
            ...
            <?php if ($user_id): ?>
                <a href="<?= h($dashboard_link) ?>" class="btn btn-primary"><i class="bi bi-speedometer2"></i> Aller à mon espace</a>
            <?php else: ?>
                <a href="connexion.php" class="btn btn-primary"><i class="bi bi-box-arrow-in-right"></i> Se connecter</a>
            <?php endif; ?>
        </div>
    </div>
</main>
