...
BASE    : sbeeconnect — charte graphique unifiée
=======================================================================
*/
...
<head>
    ...
    <meta name="description" content="Politique de confidentialité et protection des données personnelles de SBEE+, la plateforme officielle de la SBEE Bénin.">
    <title>Politique de confidentialité — SBEE+</title>
    ...
    <style>
/* ============================================================
   CHARTE SBEE+ – IDENTIQUE À COUPURES.PHP / PANNES.PHP
   ============================================================ */
:root {
    --primary: #A83236;
    --primary-dark: #7E2428;
...
.content-pad-top { padding: 22px 22px 0; }
.section-label {
...
.privacy-text { padding: 0 22px 22px; color: var(--text-soft); font-size: 13px; line-height: 1.7; }
.privacy-text p { margin: 1.2em 0; }
.privacy-text ul { margin: 0.8em 0; padding-left: 1.5em; }
.privacy-text li { margin: 0.5em 0; }
.privacy-text a { color: var(--primary-dark); text-decoration: underline; }
.privacy-text a:hover { color: var(--primary); }
.legal-subtitle {
...
@media (max-width: 520px) {
    ...
    .content-pad-top, .privacy-text { padding-left: 16px; padding-right: 16px; }
}
    ...
    <div class="page-header">
        <div class="header-wrap">
            <div>
                ...
                <p class="header-sub">Protection de vos données personnelles sur SBEE+.</p>
            </div>
            <div><span class="role-badge"><i class="bi bi-shield-lock-fill"></i> Confidentialité</span></div>
        </div>
    </div>
    ...
    <div class="main-content">
        <div class="section-card">
            <div class="content-pad-top">
                <div class="section-label"><i class="bi bi-shield-lock-fill"></i> Politique de confidentialité</div>
                <div class="section-sub">Dernière mise à jour : <?= date('d/m/Y') ?></div>
            </div>
            <div class="privacy-text">
                <p>La Société Béninoise d'Énergie Électrique (SBEE) accorde une importance capitale à la protection de vos données personnelles. Cette politique vous informe de la manière dont nous collectons, utilisons, conservons et protégeons vos informations conformément à la loi n° 2017-20 du 20 avril 2018 sur l'économie numérique et au Règlement Général sur la Protection des Données (RGPD).</p>

                <div class="legal-subtitle">1. Qui est responsable du traitement ?</div>
                <p>Le responsable de traitement est la <strong>Société Béninoise d'Énergie Électrique (SBEE)</strong>, représentée par son Directeur Général. Pour toute question relative à vos données personnelles, vous pouvez contacter notre Délégué à la Protection des Données (DPO) :</p>
                <ul>
                    <li>Email : <a href="mailto:dpo@sbee.bj">dpo@sbee.bj</a></li>
                    <li>Adresse postale : SBEE – DSI, 01 BP 123, Cotonou, Bénin</li>
                </ul>

                <div class="legal-subtitle">2. Quelles données collectons-nous ?</div>
                <p>Selon l'utilisation que vous faites de nos services, nous sommes susceptibles de collecter :</p>
                <ul>
                    <li><strong>Données d'identification :</strong> nom, prénom, numéro de téléphone, adresse email, adresse postale, numéro de compteur électrique, zone de résidence.</li>
                    <li><strong>Données de connexion :</strong> identifiants, mot de passe haché, historique de connexion (date, heure, adresse IP).</li>
                    <li><strong>Données liées aux signalements :</strong> type de panne, description, localisation, photos éventuelles, historique des statuts, évaluations.</li>
                    <li><strong>Données de localisation :</strong> coordonnées GPS (si vous utilisez la fonction "Ma position" sur la carte).</li>
                    <li><strong>Données techniques :</strong> type d'appareil, navigateur, système d'exploitation, cookies techniques.</li>
                </ul>

                <div class="legal-subtitle">3. Comment collectons-nous vos données ?</div>
                <ul>
                    <li><strong>Directement :</strong> lors de la création d'un compte, du signalement d'une panne, du remplissage d'un formulaire de contact.</li>
                    <li><strong>Indirectement :</strong> via les cookies de session nécessaires au fonctionnement du site, les journaux d'accès serveur.</li>
                </ul>

                <div class="legal-subtitle">4. Pourquoi utilisons-nous vos données ?</div>
                <p>La SBEE traite vos données personnelles pour les finalités suivantes :</p>
                <ul>
                    <li>Gérer votre compte abonné et votre authentification.</li>
                    <li>Traiter et suivre vos signalements de pannes électriques.</li>
                    <li>Vous informer par SMS ou email de l'évolution de votre dossier.</li>
                    <li>Vous envoyer des alertes concernant les coupures programmées dans votre zone.</li>
                    <li>Améliorer nos services et la qualité des interventions (analyses statistiques).</li>
                    <li>Répondre à vos demandes via le formulaire de contact.</li>
                    <li>Respecter nos obligations légales et réglementaires (conservation des archives).</li>
                </ul>
                <p>Les bases légales sont : l'exécution du service public, votre consentement (pour les notifications optionnelles), le respect d'une obligation légale (conservation des factures).</p>

                <div class="legal-subtitle">5. Combien de temps conservons-nous vos données ?</div>
                <ul>
                    <li><strong>Compte abonné :</strong> 5 ans après la dernière activité (connexion ou signalement). Passé ce délai, votre compte sera désactivé et anonymisé.</li>
                    <li><strong>Signalements :</strong> 5 ans à compter de la date de résolution, à des fins de suivi et d'analyse.</li>
                    <li><strong>Données de connexion :</strong> 12 mois.</li>
                    <li><strong>Messages de contact :</strong> 3 ans.</li>
                </ul>

                <div class="legal-subtitle">6. Qui a accès à vos données ?</div>
                <p>Vos données personnelles sont accessibles uniquement aux personnes habilitées de la SBEE :</p>
                <ul>
                    <li>Agents du centre d'appels et du service client (pour le traitement des signalements).</li>
                    <li>Techniciens terrain (pour intervenir à l'adresse indiquée).</li>
                    <li>Administrateurs des systèmes d'information (maintenance, sécurité).</li>
                </ul>
                <p>Nous pouvons également partager certaines données avec des sous-traitants techniques (hébergeur, plateforme d'envoi de SMS) strictement nécessaires à la fourniture du service. Ces sous-traitants sont tenus par des clauses contractuelles de confidentialité et de sécurité.</p>
                <p>Aucune donnée n'est vendue à des tiers ou utilisée à des fins de marketing sans votre consentement exprès.</p>

                <div class="legal-subtitle">7. Comment vos données sont-elles sécurisées ?</div>
                <p>La SBEE met en œuvre des mesures techniques et organisationnelles appropriées pour garantir un niveau de sécurité adapté au risque :</p>
                <ul>
                    <li>Cryptage des mots de passe (hachage SHA256).</li>
                    <li>Communication chiffrée via HTTPS.</li>
                ...
                <p>En cas de violation de données susceptible d'engendrer un risque élevé pour vos droits, nous vous en informerons ainsi que l'autorité de contrôle compétente.</p>

                <div class="legal-subtitle">8. Quels sont vos droits ?</div>
                <p>Conformément à la réglementation, vous disposez des droits suivants sur vos données personnelles :</p>
                <ul>
                    <li><strong>Droit d'accès :</strong> savoir quelles données nous détenons et obtenir une copie.</li>
                    <li><strong>Droit de rectification :</strong> corriger des données inexactes ou incomplètes.</li>
                    <li><strong>Droit d'effacement :</strong> demander la suppression de vos données, sous réserve de nos obligations légales.</li>
                    <li><strong>Droit d'opposition :</strong> vous opposer à un traitement basé sur notre intérêt légitime.</li>
                ...
                <p>Pour exercer vos droits, adressez votre demande accompagnée d'une pièce d'identité à : <a href="mailto:dpo@sbee.bj">dpo@sbee.bj</a> ou par courrier à la DSI SBEE. Nous répondrons dans un délai maximum d'un mois.</p>
                <p>Si vous estimez que vos droits n'ont pas été respectés, vous avez la possibilité d'introduire une réclamation auprès de l'Autorité de Protection des Données Personnelles du Bénin (APDP).</p>

                <div class="legal-subtitle">9. Cookies et technologies similaires</div>
                <p>Le site SBEE+ utilise uniquement des cookies strictement nécessaires à la navigation et à la sécurité :</p>
                <ul>
                    <li><strong>Cookie de session (PHPSESSID) :</strong> indispensable pour maintenir votre connexion.</li>
                    <li><strong>Cookie "se souvenir de moi" :</strong> optionnel, stocke un identifiant chiffré pour éviter de vous reconnecter à chaque visite.</li>
                    <li><strong>Cookies techniques de performance interne (non publicitaires).</strong></li>
                </ul>
                <p>Nous n'utilisons pas de cookies de traçage tiers, de publicité ciblée ou de réseaux sociaux sans votre consentement exprès. Vous pouvez paramétrer votre navigateur pour bloquer les cookies, mais certaines fonctionnalités pourraient être altérées.</p>

                <div class="legal-subtitle">10. Transferts de données hors du Bénin</div>
                <p>Vos données sont hébergées sur des serveurs situés au Bénin ou en Union Européenne (selon votre hébergeur). Si un transfert vers un pays tiers est nécessaire (ex : solution d'envoi de SMS), nous garantissons un niveau de protection adéquat via des clauses contractuelles types ou la participation au Privacy Shield.</p>

                <div class="legal-subtitle">11. Mineurs</div>
                <p>Le service n'est pas destiné aux mineurs de moins de 16 ans sans autorisation parentale. Si nous découvrons des données d'un mineur sans consentement valable, nous les supprimerons rapidement.</p>

                <div class="legal-subtitle">12. Modification de la politique de confidentialité</div>
                <p>La SBEE se réserve le droit de mettre à jour cette politique pour refléter les évolutions légales ou techniques. Toute modification sera publiée sur cette page avec une date de révision actualisée. Nous vous encourageons à la consulter régulièrement.</p>
